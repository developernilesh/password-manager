...
import { FiCopy, FiCreditCard, FiEdit, FiEye, FiEyeOff, FiTrash2 } from "react-icons/fi";
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className={`w-10 h-10 bg-gradient-to-r ${getCategoryIconColors(card.category)} rounded-lg flex items-center justify-center`}>
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <span className="font-mono">
                    {vis.number ? card.cardNumber : maskCardNumber(card.cardNumber)}
                  </span>
                  <button
                  ...
                  <button
                    ...
                    className="p-1 hover:bg-gray-600 rounded transition-colors"
                    aria-label={
                      copiedByKey[`${card.id}-number`] ? "Copied" : "Copy number"
                    }
                    title={
                      copiedByKey[`${card.id}-number`] ? "Copied" : "Copy number"
                    }
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <span className="font-mono">{vis.cvv ? card.cvv : "***"}</span>
                  <button
                  ...
                  <button
                    onClick={() => handleCopy(`${card.id}-cvv`, card.cvv, "cvv")}
                    className="p-1 hover:bg-gray-600 rounded transition-colors"
                    aria-label={
                  ...
                  >
                    {copiedByKey[`${card.id}-cvv`] ? (
                      ...
                      <FiCopy className="h-4 w-4 text-gray-400" />
                             ...
                             <div>
                 <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getCategoryColors(card.category)}`}>
